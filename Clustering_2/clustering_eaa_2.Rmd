...
Of course, we can do the same plot for GMM:
...
The RandIndex shows that the new segmentation differs indeed not too much from the previous one.
...
```{r}
set.seed(seed_var)
cclust_noClaimPaid_res <- cclust(da%>% select(-ClaimPaid),k=7)
```
